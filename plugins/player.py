...
async def play(_, message: Message):
    ...
    lel = await message.reply("** Dhundra ...**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 Ƥɭɘɑsɘ ❤️ Ɱɑŋʋɑɭɭy 🥀 Ʌɗɗ 💫 Ʌssɩsʈɑŋʈ 😔 Øɤ 🎸 Ƈøŋʈɑƈʈ ❤️ ʈø : @wtf_toxicop 🥀** ")
    try:
    ...
    if audio:
        ...
        await lel.edit("**sabar rakho jara ...**")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="hhttps://telegra.ph//file/df6dd71fe22b4c51f8594.jpg", 
                             caption="** Toxic 🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("** Toxic 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
